...
interface ImageCarouselCmsProps {
	updateSlide(id: string, value: string): void;
	fieldName: string;
	id: string;
	section: any;
	value: string;
...
export default ImageCarouselCms;
