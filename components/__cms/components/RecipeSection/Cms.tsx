...
interface RecipeSectionCmsProps {
	section: any;
	handleSectionDataChange: any;
	handleExplicitSectionDataChange: any;
}

const RecipeSectionCms = ({ section, handleExplicitSectionDataChange }: RecipeSectionCmsProps) => {
			...
			<Grid container spacing={1}>
				<Grid item xs={12}>
					<Referencer
						entityName="recipes"
						useHook={useRecipes}
						entityFieldPrefix="recipe"
						section={section}
						fieldName="featuredRecipes"
						handleExplicitSectionDataChange={handleExplicitSectionDataChange}
					/>
				</Grid>
			</Grid>
...
export default RecipeSectionCms;
