	...
	return image && content ? (
		...
		>
			<Container
				maxWidth={"lg"}
				style={{
					padding: mobileWidth ? "0rem" : "2rem 0.5rem",
					paddingRight: mobileWidth ? 0 : "1rem",
					background: colorSettings === "Custom" ? sectionBackgroundColor : "none",
				}}
			>
				<Grid container spacing={mobileWidth ? 2 : 0}>
					<Grid
						item
						xs={12}
						sm={12}
						md={6}
						style={{
							padding: mobileWidth ? "24px 24px 24px 40px" : "0px 24px",
						}}
					>
						<div
							style={{
